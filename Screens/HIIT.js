  ...
  const workouts = [
    {
      ...
      image: require('../assets/banner/3/highknees.gif'),
    },
    {
      id: 2,
      name: 'Mountain Climbers',
      reps: '12 reps and 3 sets',
      image: require('../assets/banner/3/MountainClimber.gif'),
    },
    {
      id: 3,
      name: 'Plank Jacks',
      reps: '12 reps and 3 sets',
      image: require('../assets/banner/3/plankjacks.gif'),
    },
    {
      id: 4,
      name: 'Speed Skaters',
      reps: '12 reps and 3 sets',
      image: require('../assets/banner/3/speedskaters.gif'),
    },
    {
      id: 5,
      name: 'Tuck Jumps',
      reps: '12 reps and 3 sets',
      image: require('../assets/banner/3/tuckjump.gif'),
    },
    {
      id: 6,
      name: 'Jump Squats',
      reps: '12 reps and 3 sets',
      image: require('../assets/banner/3/jumpsquats.gif'),
    },
    {
        id: 7,
        name: 'Butt Kicks',
        reps: '12 reps and 3 sets',
        image: require('../assets/banner/3/buttkicks.gif'),
      },
      {
        id: 8,
        name: 'Jump lunges',
        reps: '12 reps and 3 sets',
        image: require('../assets/banner/3/jumplunges.gif'),
      },
      {
        id: 9,
        name: 'Russian twists',
        reps: '12 reps and 3 sets',
        image: require('../assets/banner/3/russiantwist.gif'),
      },
  ];
